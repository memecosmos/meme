...
export const Params = {
  encode(message: Params, writer: Writer = Writer.create()): Writer {
    ...
    if (message.max_wasm_code_size !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.max_wasm_code_size = longToNumber(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Params {
    ...
    if (
      ...
      message.max_wasm_code_size = Number(object.max_wasm_code_size);
    } else {
      message.max_wasm_code_size = 0;
    }
    return message;
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.max_wasm_code_size !== undefined &&
      (obj.max_wasm_code_size = message.max_wasm_code_size);
    return obj;
  },
